...
A static toolkit of 26 file utilities — merge, split, redact, sign and convert PDFs, Word, Excel, PowerPoint, HTML and images — that run **entirely in the browser**. No backend, no upload, no tracking: the work happens on your own device.
